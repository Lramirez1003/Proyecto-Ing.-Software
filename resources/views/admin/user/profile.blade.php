...
<body>
    ...
    <h3 id="hola"> <nobr> Sebastián Sanchez</h3>
    <p id="parrafito">A medida que vayas rentando, se te iran sumando puntos hasta poder canjearlos  </p>
    <div id="bloqueDorado" >
        <img src="images/iconopuntos.png" alt="points" width="28px" height="28px" style="margin-top:5px;"> 20 puntos
    ...
    <div >
        <input type="text" class="bloqueGris">
            <label class="textoBloques">Nombre
            </label>
    </div>

    <div class="bloqueGris" style="top: 486px;" >
            <div class="textoBloques">Correo electronico
            </div>
    </div>

    <div class="bloqueGris" style="top: 558px;"  >
        <div class="textoBloques">Contraseña
        </div>
    </div>

    <div class="bloqueGris" style="top: 630px;">
        <div class="textoBloques">Cédula
        </div>
    </div>

    <div class="bloqueGris" style="top: 702px;" >
        <div class="textoBloques">Licencia
        </div>
    </div>
